...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::rotate(model, mainWindow.getRotacionDado() * toRadians, glm::vec3(0.0f, 1.0f, 0.0f)); // Para que rote igual que tus dados
		...
		// ====================================================================================
		// Ejercicio 1 - DADO TEXTURIZADO: Texturizar su cubo con la imagen dado_animales
		model = glm::mat4(1.0);
		...
		// ====================================================================================
		// Ejercicio 2 - DADO IMPORTADO: Importar el cubo texturizado en el programa de modelado
		// con la imagen dado_animales
		model = glm::mat4(1.0);
